...
import { DropboxDiv, LyricListBodyItemDiv, MyPageProfileDiv, MyProfileImage, MyProfileSpan} from '../../styles/mypageStyle';
  ...
  return (
    <div>
      <MyPageProfileDiv>
        ...
        <MyProfileSpan onClick={onProfileHandler}>
          회원정보관리
        </MyProfileSpan>
        <MyProfileSpan onClick={onLogoutHandler}>
            로그아웃
        </MyProfileSpan>
